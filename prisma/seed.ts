  ...
  await prisma.kPISnapshot.createMany({
    data: [
      ...
      },
      {
        ...
        computedAt: dashboardComputedAt,
        value: new Prisma.Decimal('1.03'),
        status: KpiStatus.GREEN,
        ev: new Prisma.Decimal('38000.00'),
        pv: new Prisma.Decimal('36900.00'),
        ac: new Prisma.Decimal('40000.00'),
      },
      {
        projectId: project.id,
      ...
      // Project Beta
      {
        ...
        ev: new Prisma.Decimal('22000.00'),
        pv: new Prisma.Decimal('30000.00'),
        ac: new Prisma.Decimal('26800.00'),
      },
      {
        projectId: project2.id,
        kpiDefinitionId: betaSpiDef.id,
        computedAt: dashboardComputedAt,
        value: new Prisma.Decimal('0.88'),
        status: KpiStatus.RED,
        ev: new Prisma.Decimal('22000.00'),
        pv: new Prisma.Decimal('25000.00'),
        ac: new Prisma.Decimal('26800.00'),
      },
      {
        projectId: project2.id,
        ...
        computedAt: dashboardComputedAt,
        value: new Prisma.Decimal('2100.00'),
        status: KpiStatus.YELLOW,
        ev: new Prisma.Decimal('22000.00'),
        pv: new Prisma.Decimal('25000.00'),
        ac: new Prisma.Decimal('26800.00'),
